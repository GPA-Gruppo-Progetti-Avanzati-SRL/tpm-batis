...
func Delete(tx *sqlx.Tx, filter sqlmapper.Filter, opts ...DeleteOp) (int, error) {

	const semLogContext = "person::delete"
...
func DeleteByPrimaryKey(tx *sqlx.Tx, pk PrimaryKey, opts ...DeleteOp) (int, error) {
	...
	const semLogContext = "person::delete-by-primary-key"
